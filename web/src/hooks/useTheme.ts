...
interface UseThemeReturn {
  theme: Theme;
  codeTheme: typeof darcula | typeof googlecode;
 ...
 *
 * @returns true if dark theme should be applied
 *
 ...
 *
 * @param theme - User's preference: "light", "dark", or "system"
 * @returns Always "light" or "dark" (never "system")
 *
 ...
 *
 * @param theme - User's theme preference
 * @returns Theme object for react-syntax-highlighter
 *
 ...
 */
const getCodeTheme = (theme: Theme) => {
  const effectiveTheme = getEffectiveTheme(theme);
...
export const useTheme = (): UseThemeReturn => {
   ...
   * Set theme function
   *
   * @param newTheme - "light" | "dark" | "system"
   *
   * Logic:
